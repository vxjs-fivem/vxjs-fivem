...
export enum VehicleDoorsLockStatus {
  NONE,
  UNLOCKED,
  LOCKED,
  LOCKED_FOR_PLAYERS,
...
export enum VehicleLockOnState {
  NotLocked,
  LockingOn,
  LockedOn,
}

export enum VehicleEnteringSpeed {
  Walk = 1,
  Run = 2,
}

export enum VehicleEnteringFlag {
  Normal = 1,
  Teleport = 3,
  TeleportDirectly = 16,
}

export enum VehicleExitingFlag {
  NormalAndCloseDoor = 0,
  NormalAndCloseDoor_2 = 1,
  TeleportOutsideDoorsClosed = 16,
  NormalAndCloseDoorSlower = 64,
  NormalAndDontCLoseDoor = 256,
  ThrowSelfOut = 4160,
  MoveToPassengerSeatAndExit = 262144,
}
